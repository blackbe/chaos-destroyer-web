...
## Tonight I built: HugBack Feature #60
**Location-based search (geolocation) — From Trello Phase 2 #61**

**Date:** 2026-04-10  
**Output location:** `/Users/benblack/.openclaw/workspace/nightly-builds/outputs/2026-04-10-hugback-60/`
...
### If the build failed:
1. Check the build errors in `/Users/benblack/.openclaw/workspace/nightly-builds/outputs/2026-04-10-hugback-60/` or the log file
